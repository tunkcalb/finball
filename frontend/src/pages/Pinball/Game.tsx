...
function Game(value) {
  ...
  const setColor = () => {
    ...
    for (let i = 0; i < membercnt; i++) {
      ...
      for (let j = 0; j < members[i].balance / ballunit; j++) {
        B.push(
          Object.keys(userColor).find(
            (key) => userColor[key] == members[i]["name"]
          )
        );
      }
    }
      ...
      const updateScroll = () => {
        if (updatedBalls.length > 0) {
          ...
          if (
            ...
            setWhiteCount(
              Pay.filter((ball) => ball.render.fillStyle === "white").length
            );
            setPurpleCount(
  ...
  return (
    <div
      id="canvas"
      style={{ width: "360px", height: "1800px" }}
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "flex-end" }}>
        ...
        >
          ...
          {userColor["red"] != "unknown" ? (
            <div style={{ color: "red" }}>
              <img
                src={redball}
                style={{ width: "10px", height: "10px", marginRight: "6px" }}
              />
          ...
          {userColor["yellow"] != "unknown" ? (
            <div style={{ color: "black", WebkitTextStroke: "0.2px yellow" }}>
              <img
                src={yellowball}
                style={{ width: "10px", height: "10px", marginRight: "6px" }}
              />
          ...
          {userColor["white"] != "unknown" ? (
            <div style={{ color: "black", WebkitTextStroke: "0.2px white" }}>
              <img
                src={whiteball}
                style={{ width: "10px", height: "10px", marginRight: "6px" }}
              />
              {userColor["white"]} : {whiteCount}
            </div>
          ) : (
            ""
          )}
